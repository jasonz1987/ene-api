 ...
 * @Command
 */
class GetPrice extends HyperfCommand
{
    /**
    ...
    public function __construct(ContainerInterface $container)
    {
        ...
        parent::__construct('get:price');
    }

    public function configure()
    {
        parent::configure();
        $this->setDescription('获取价格');
    }
    ...
    public function handle()
    {
        ...
        $contractAddress = '0x800bc26fB963F22A446D1Bc5edaE01D397ff28F9';
        ...
        $contract->at($contractAddress)->call('getReserves', [
